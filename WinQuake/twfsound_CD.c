...
/*GFS*/  ULONG TWFCD_ReadTOC(struct TWFCDData *tcrt_CDData)
{
    ULONG ReturnCode = 0;
    BYTE  Position   = 0;
    ULONG Status     = 0;
...
/*GFS*/  ULONG TWFCD_PlayTracks(struct TWFCDData *tcpt_CDData, struct TagItem *pt_Tags)
{
...
/*GFS*/  ULONG TWFCD_StopPlay(struct TWFCDData *tcsp_CDData)
{
    ULONG ReturnCode = 0;
    ULONG Status     = 0;
...
/*GFS*/  ULONG TWFCD_PausePlay(struct TWFCDData *tcpp_CDData)
{
...
/*GFS*/  ULONG TWFCD_MotorControl(struct TWFCDData *tcmc_CDData, UBYTE newStatus)
{
    ULONG returnCode  = 0;
    ULONG status      = 0;
    UBYTE ejectCmd[6] =
...
/*GFS*/  ULONG TWFCD_ReadSubChannel(struct TWFCDData *tcrs_CDData)
{
