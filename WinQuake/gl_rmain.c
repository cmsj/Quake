...
cvar_t  r_skybox = {"r_skybox", "0", true}; // m3x: added
...
cvar_t  gl_multitexture = {"gl_multitexture", "1", true}; // m3x: added

// Torch flares. KH
cvar_t  gl_torchflares = {"gl_torchflares", "0", true};
...
void R_SetupGL (void)
{
  ...
  //if ((h + y2) == vid.height) y2 = 0;   //  30/01/2000 added: M.Tretene
